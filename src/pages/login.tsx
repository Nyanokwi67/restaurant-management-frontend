    ...
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="w-full max-w-md px-6">
        <motion.div
          ...
          className="bg-gray-50 rounded-3xl shadow-2xl p-8 border-2 border-gray-100"
        >
          <div className="text-center mb-8">
            <motion.div
              ...
              className="w-16 h-16 bg-gray-900 rounded-2xl flex items-center justify-center mx-auto mb-4"
            >
            ...
            >
              Sign in to access the restaurant system
            </motion.p>
          </div>
