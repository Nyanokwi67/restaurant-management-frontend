...
import orderManagement from '../assets/images/order-management.jpg';
import paymentProcessing from '../assets/images/payment-processing.jpg';
import analyticsReports from '../assets/images/analytics-reports.jpg';
import tableManagement from '../assets/images/table-management.jpg';
import menuControl from '../assets/images/menu-control.jpg';
import staffManagement from '../assets/images/staff-management.jpg';
import realtimeSync from '../assets/images/realtime-sync.jpg';
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 hover:shadow-lg transition"
            >
